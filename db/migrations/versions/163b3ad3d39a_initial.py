...
def upgrade() -> None:
    ...
    sa.Column('source', sa.Enum('hn', 'rss', 'reddit', 'twitter', 'youtube', name='source_enum'), nullable=False),
    ...
    op.create_index('ix_content_items_quality_score', 'content_items', ['quality_score'], unique=False)
    ...
    sa.Column('delivery_time', sa.String(length=5), nullable=True, comment="HH:MM in UTC, e.g. '08:00'"),
    ...
    sa.Column('source_surface', sa.Enum('email', 'web', name='source_surface_enum'), nullable=False),
    ...
    op.create_index('ix_interactions_user_content', 'interactions', ['user_id', 'content_id'], unique=False)
